...
class RiskAnalysis:
    ...
    def __init__(self, data_dict, risk_free_rate=0.01, logger=None):
        ...
        evaluating the performance of other investments, as it reflects the minimum return an investor would expect for taking on additional risk.
    ...
    def calculate_VaR(self, returns, confidence_level=0.95):
        ...
        - confidence_level (float): Confidence level for VaR calculation.(95% confidence level means
          that you expect to lose more than the calculated VaR only 5% of the time.)
