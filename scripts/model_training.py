...
class ModelTrainer:
    def __init__(self, data, logger=None, column='Close'):
        ...
        """
        self.df = data  # Store the input data as a DataFrame in the instance variable df.
        self.column = column  # Store the name of the column to forecast in the instance variable column.
        self.logger = logger  # Store the logger instance for logging purposes.
        self.train = None  # Initialize the training dataset as None.
        self.test = None  # Initialize the testing dataset as None.
        self.model = {}  # Initialize a dictionary to hold the trained models.
        self.prediction = {}  # Initialize a dictionary to store predictions.
        self.metric = {}  # Initialize a dictionary to store evaluation metrics.
        self.scaler = MinMaxScaler(feature_range=(0, 1))  # Initialize the MinMaxScaler to scale data between 0 and 1.
    ...
    def forecast(self, months=12, output_file='forecast_results.csv', best_model=None, alpha=0.05):
        ...
        # Ensure self.metric is populated (models must be evaluated first)
        if not self.metric:
            raise ValueError("No models have been trained or evaluated. Please train and evaluate models first.")
